        ...
        <div class="w-full bottom-0 h-16 list-none flex list-none space-x-10 justify-center items-center min-w-[300px] min-h-[64px] my-4">
          <li>
            <a href='https://www.linkedin.com/in/annabellatian/'>
              <svg className="fill-darkGray" width="24" height="24"><path d="M4.98 3.5C4.98 4.881 3.87 6 2.5 6S.02 4.881.02 3.5C.02 2.12 1.13 1 2.5 1s2.48 1.12 2.48 2.5zM5 8H0v16h5V8zm7.982 0H8.014v16h4.969v-8.399c0-4.67 6.029-5.052 6.029 0V24H24V13.869c0-7.88-8.922-7.593-11.018-3.714V8z"/></svg>
            </a>
          </li>
          <li>
            <a href='https://github.com/annabellatian'>
            <svg className="fill-darkGray" width="24" height="24" viewBox="0 0 24 24">
          ...
          <li>
            <a href='https://open.spotify.com/user/getcupcaked?si=e55d92ab55644dc6'>
              <svg className="fill-darkGray" width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd"><path d="M19.098 10.638c-3.868-2.297-10.248-2.508-13.941-1.387-.593.18-1.22-.155-1.399-.748-.18-.593.154-1.22.748-1.4 4.239-1.287 11.285-1.038 15.738 1.605.533.317.708 1.005.392 1.538-.316.533-1.005.709-1.538.392zm-.126 3.403c-.272.44-.847.578-1.287.308-3.225-1.982-8.142-2.557-11.958-1.399-.494.15-1.017-.129-1.167-.623-.149-.495.13-1.016.624-1.167 4.358-1.322 9.776-.682 13.48 1.595.44.27.578.847.308 1.286zm-1.469 3.267c-.215.354-.676.465-1.028.249-2.818-1.722-6.365-2.111-10.542-1.157-.402.092-.803-.16-.895-.562-.092-.403.159-.804.562-.896 4.571-1.045 8.492-.595 11.655 1.338.353.215.464.676.248 1.028zm-5.503-17.308c-6.627 0-12 5.373-12 12 0 6.628 5.373 12 12 12 6.628 0 12-5.372 12-12 0-6.627-5.372-12-12-12z"/></svg>
            </a>
          </li>
          {/* <li>
          ...
          <li>
            <a href='https://www.youtube.com/@annabellatian4313'>
              <svg className="fill-darkGray" width="24" height="24" viewBox="0 0 24 24" >
                <path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z" fill="#0F0605"/>
              </svg>
            </a>
          </li>
          <li className='my-0 flex'>
            <button className="self-center" onClick={copyToClipboard}>
              <svg className="fill-darkGray" width="25" height="25" viewBox="0 0 25 25" class="size-6">
