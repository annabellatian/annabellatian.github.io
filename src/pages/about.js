  ...
  return (
    <div className='section-container'>
      <div className='py-4'>
        ...
        <Fade>
          <h4 className='sm:text-xl sm:leading-relaxed text-l pb-4 font-bodyText'>
            During my time at Penn, I have worked as a developer for <a className="link" href="https://www.thedp.com/">The Daily Pennsylvanian, Inc.</a> as well as a teaching assistant for Penn's data structures and algorithms course (<a className="link" href="https://www.cis.upenn.edu/~cis1210/current/">CIS 1210</a>).
