...
const NorwegianWood = () => {
  return (
    <div className='flex grow text-textColor mx-[10%] sm:mx-[15%] items-start min-w-[300px]'>
      <div className='py-4'>
        <h1 className='text-4xl pb-4 font-bekinderOut leading-relaxed'>Book Review: <span className="font-bekinder italic">Norwegian Wood</span>&nbsp; <span className="font-bekinder">by Haruki Murakami</span></h1>
